...
class CreateReportsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('reports', function (Blueprint $table) {
            ...
            $table->text('descriptionMata')->nullable();
            $table->text('keywordsMeta')->nullable();
            $table->text('news_keywordsMeta')->nullable();
            $table->text('robotsMeta')->nullable();
            $table->text('viewportMeta')->nullable();
            ...
            $table->text('ampLink')->nullable();
            $table->text('favicon')->nullable();
            $table->text('robotsFile')->nullable();
